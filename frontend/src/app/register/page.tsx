        ...
        <div className="min-h-screen flex items-center justify-center px-4">
            <Card className="w-full max-w-sm animate-fade-in-scale">
                <CardHeader className="text-center pb-2 pt-8">
                    ...
                    <p className="text-sm text-[#4A4A45] mt-2">Create your account</p>
                </CardHeader>
                <CardContent className="space-y-5 px-8 pb-8 pt-4">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            <Label className="text-xs text-[#4A4A45] uppercase tracking-wider font-medium">Name</Label>
                            <div className="relative">
                                <User className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[#8A8880]" />
                                <Input value={name} onChange={(e) => setName(e.target.value)} placeholder="Your name" className="pl-10 h-11" autoFocus />
                            </div>
                        </div>
                        <div className="space-y-1.5">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                ...
                                <Input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Min 6 characters" className="pl-10 pr-10 h-11" required minLength={6} />
                    ...
                    <p className="text-center text-xs text-[#8A8880]">5 free invoices every month · No credit card required</p>
                    <div className="text-center space-y-3">
                        <p className="text-sm text-[#4A4A45]">
                            Already have an account?{" "}
                            <Link href="/login" className="text-[#D4A017] hover:text-[#B8860B] font-medium">Sign in</Link>
                        </p>
                    </div>
                </CardContent>
            </Card>
